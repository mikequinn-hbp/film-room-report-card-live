export const SCOREBOARD_DATA = {
  ...
  gradingIntro:
    "This report card is built first off participation, attendance, punctuality, leadership, follow-through, proof of work, and how a person shows up to the room and to the people around them. Advisor Tekmetric production is a lighter modifier built off posted plus total sold pace. GM Tekmetric production is weighted harder because GMs are leading full stores and setting the standard future GMs are training toward. When a live Tekmetric pull is unavailable, the last verified production modifier stays in place until the next successful refresh.",
  gradingStandard:
  ...
  members: [
    ...
    },
    {
      ...
      grade: "D",
      note: "Needs another push • $71.0k MTD",
      trend: "down",
      points: 7,
      modifier: "Neutral: 0 advisor pace modifier. Posted $71.0k and sold $91.9k vs a $72.0k pace target through Apr 18. Sold is good, posted is just under.",
      doing: "Got on the board early, then cooled off in Slack, but the sold pace in Tekmetric is still strong.",
    ...
    },
    {
      name: "JT",
      grade: "F",
      note: "Quiet here • $74.2k MTD",
      trend: "hold",
      points: 3,
      modifier: "Boost: +2 advisor pace. Posted $74.2k and sold $77.4k vs a $72.0k pace target through Apr 18.",
      doing: "Not giving the room enough visible action right now, even though both posted and sold pace are running ahead in Tekmetric.",
      improve: "Needs more visible reps, stronger communication, and follow-through in the room."
    },
    {
      name: "Victor Naji",
      grade: "F",
      note: "GM lane • Sienna is mixed",
      trend: "hold",
      points: 1,
      modifier: "Neutral: 0 GM leadership modifier. NOW Sienna is at $245.6k posted and $305.4k sold vs a $300.0k pace target. GP% is neutral today until the live end-of-day gross-profit field is confirmed.",
      doing: "The sold side is doing its part, but the posted side and the room activity still are not strong enough to lift the grade.",
    ...
    },
    {
      ...
      trend: "new",
      points: 1,
      doing: "Luis is now included on the board after joining the channel, so he is officially being tracked.",
